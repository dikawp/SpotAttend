                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="role" name="role" required
                                ...
                                <option value="0" {{ old('role', $employee->user->role) == '0' ? 'selected' : '' }}>Employee (Role 0)</option>
                                <option value="1" {{ old('role', $employee->user->role) == '1' ? 'selected' : '' }}>HR Admin (Role 1)</option>
                            </select>
                        </div>
                        @endif
